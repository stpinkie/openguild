...
| **Polkadot Hub Testnet** | Testnet |

### Optional: If you want to deploy to Polkadot Hub Testnet
...
![Access Kusama AssetHub](/static/images/polkadot/blog/polkadot-deploy-uniswapv2/asset_hub.png)

2.  Navigate to **Developer \> Extrinsics**.
3.  Submit the extrinsic: `revive.mapAccount()`.

![Map Account](/static/images/polkadot/blog/polkadot-deploy-uniswapv2/map_account.png)
...
> **💡 Important: The project already configured `Polkadot Hub Testnet` and `Kusama Asset Hub` on `hardhat.config.js` **
...
```bash
npx hardhat ignition deploy ignition/modules/UniswapV2ERC20.js --network <polkadotHubTestnet or kusamaHub>
```
...
[ UniswapV2ERC20Module ] successfully deployed 🚀
...
```bash
npx hardhat ignition deploy ignition/modules/UniswapV2WETH.js --network <polkadotHubTestnet or kusamaHub>
```
...
[ UniswapV2WETHModule ] successfully deployed 🚀
...
```bash
npx hardhat ignition deploy ignition/modules/UniswapV2Factory.js --network <polkadotHubTestnet or kusamaHub>
```
...
[ UniswapV2FactoryModule ] successfully deployed 🚀
...
```bash
npx hardhat ignition deploy ignition/modules/UniswapV2Pair.js --network <polkadotHubTestnet or kusamaHub>
```
...
[ UniswapV2PairModule ] successfully deployed 🚀
...
Your next steps could be:
  ...
  * **Provide Liquidity:** Create new pairs and add funds to your liquidity pools.
    ...
    ![Add Liquidity](/static/images/polkadot/blog/polkadot-deploy-uniswapv2/add_liquidity.png)

  * **Swap Tokens:** Execute trades using the UI.

    ![Swap Tokens](/static/images/polkadot/blog/polkadot-deploy-uniswapv2/swap.png)

  * **Explore:** Query and display information about all available liquidity pools.

    ![Explore](/static/images/polkadot/blog/polkadot-deploy-uniswapv2/pools.png)